    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="text-black">
        <span className="inline-block bg-white/20 px-4 py-2 rounded-full text-sm font-semibold mb-5 backdrop-blur-sm">
          Rawat Inap RS UMS A.R. Fachrudin
        </span>
        ...
        <p className="text-lg text-green-100 leading-relaxed mb-8 max-w-2xl">
          Rawat Inap RS UMS A.R. Fachrudin siap memberikan pelayanan rawat inap yang akurat dan cepat selama 24 jam dengan dukungan tenaga kesehatan profesional, fasilitas modern, serta penanganan cepat untuk berbagai kondisi kegawatdaruratan.
        </p>
