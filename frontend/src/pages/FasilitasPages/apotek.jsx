        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            <span className="inline-block bg-green-100 text-green-700 px-5 py-2 rounded-full text-sm font-semibold mb-6 shadow-sm">
              Ruang Apotek RS UMS A.R. Fachrudin
            </span>

            <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6 text-gray-900">
              Pelayanan Ruang Apotek
              <br />
              Modern & Profesional
            </h2>

            <p className="text-lg text-gray-600 leading-relaxed mb-10 max-w-2xl">
              Ruang Apotek RS UMS A.R. Fachrudin siap memberikan pelayanan
              apotek yang akurat, cepat, dan profesional selama 24 jam dengan
              dukungan tenaga medis berpengalaman, fasilitas steril, serta
              peralatan apotek modern untuk menunjang diagnosis dan pengobatan pasien.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              {[
                ...
                "Obat umum dan obat khusus",
                "Konsultasi penggunaan obat",
                "Pelayanan cepat dan aman",
                "Stok obat lengkap",
                "Tenaga apoteker profesional",
                "Suplemen kesehatan",
              ].map((item, index) => (
                <div
                  key={index}
