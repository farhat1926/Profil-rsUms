        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-10 max-w-2xl">
              Ruang Operasi RS UMS A.R. Fachrudin siap memberikan pelayanan
              operasi yang aman, cepat, dan profesional selama 24 jam dengan
              dukungan tenaga medis berpengalaman, fasilitas steril, serta
              peralatan bedah modern untuk menunjang keselamatan pasien.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              {[
                ...
                "Ruang operasi steril & modern",
                "Pemantauan kondisi pasien",
                "Pelayanan tindakan bedah",
                "Dokter bedah profesional",
