    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="text-black">
        <span className="inline-block bg-white/20 px-4 py-2 rounded-full text-sm font-semibold mb-5 backdrop-blur-sm">
          Laboratorium RS UMS A.R. Fachrudin
        </span>
        ...
        <p className="text-lg text-green-100 leading-relaxed mb-8 max-w-2xl">
          Laboratorium RS UMS A.R. Fachrudin siap memberikan pelayanan laboratorium yang akurat dan cepat selama 24 jam dengan dukungan tenaga kesehatan profesional, fasilitas modern, serta penanganan cepat untuk berbagai kondisi kegawatdaruratan.
        </p>

        {/* LIST LAYANAN */}
        <div className="space-y-4 mb-10">
          {[
                 "Pemeriksaan Laboratorium 24 Jam",
                "Pemeriksaan Darah Lengkap",
                "Pemeriksaan Urin dan Kimia Klinik",
                "Pemeriksaan Enzim dan Hormon",
