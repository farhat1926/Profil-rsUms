        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            <span className="inline-block bg-green-100 text-green-700 px-5 py-2 rounded-full text-sm font-semibold mb-6 shadow-sm">
              Ruang Laboratorium RS UMS A.R. Fachrudin
            </span>
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-10 max-w-2xl">
              Ruang Laboratorium RS UMS A.R. Fachrudin siap memberikan pelayanan
              laboratorium yang akurat, cepat, dan profesional selama 24 jam dengan
              dukungan tenaga medis berpengalaman, fasilitas steril, serta
              peralatan laboratorium modern untuk menunjang diagnosis dan pengobatan pasien.
            </p>
